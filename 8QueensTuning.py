...
def run_sa(problem, initial_state, prob_name):
    ...
    plot(max_attempts, sa_best_fit_exp_decay, sa_time_taken_exp_decay,
         "Simulated Annealing with varying max attempts with exponential decay",
         "Max Attempts",
         "Fitness",
         "Time Taken",
    ...
    plot(max_attempts, sa_best_fit_geom_decay, sa_time_taken_geom_decay,
         "Simulated Annealing with varying max attempts with Geometric decay",
         "Max Attempts",
         "Fitness",
         "Time Taken",
