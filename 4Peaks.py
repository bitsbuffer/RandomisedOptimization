...
if __name__ == '__main__':
    ...
    initial_state = np.zeros(shape=(40), dtype=int)
    # run rhc
    ...
    plt.legend()
    plt.savefig("./output/4peaks/iterations-vs-fitness.png")
    plt.show()
    # time for executiom
    plt.figure()
    ...
    plt.savefig("./output/4peaks/algorithm-vs-execution-time.png")
    plt.show()
    # algorithms vs fit
    plt.figure()
    ...
    plt.savefig("./output/4peaks/algorithm-vs-fittness-score.png")
    plt.show()
